...
const KhachHangTab = () => {
  ...
  const handleDelete = (maKH) => {
    // Backend doesn't have a delete endpoint yet, so we just alert for now.
            ...
            <form onSubmit={handleSubmit}>
              <div className="modal-body">
                <div className="form-group">
                  <label className="form-label">Mã KH (Backend tự sinh nếu trống)</label>
                  <input type="text" className="form-control" name="maKH" value={formData.maKH} onChange={handleChange} disabled={!!editingCustomer} placeholder="Để trống nếu muốn tự sinh" />
                </div>
                <div className="form-group">
